...
const content = [
  ...
  },
  {
    ...
    excerpt: 'A Video note on self-hosting Forem on your own digital ocean server.',
  },
];
...
const BlogCards = () => {
  return (
    <div className=' bg-white p-8 dark:bg-gray-800'>
      ...
      <section className='lg:flex lg:justify-center lg:pt-12'>
        {content.map((blog) => (
          <div key={blog.id}>
            <div className='relative bg-gray-100 dark:bg-gray-900 lg:mx-8 lg:flex lg:rounded-lg lg:shadow-lg'>
              ...
              <div className='max-w-xl px-6 lg:w-1/2 lg:p-4'>
